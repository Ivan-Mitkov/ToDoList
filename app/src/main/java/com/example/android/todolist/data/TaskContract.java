...
/* Add content provider constants to the Contract
     ...
     these content URI's for the path to that data:
        1) Content authority, which is how your code knows which Content Provider to access
        2) Base content URI,
        3) Path(s) to the tasks directory. Define the possible paths for accessing data in this contract
        This is the path for the "tasks" directory
        4) Content URI for data in the TaskEntry class. T
      */
